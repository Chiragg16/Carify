...
const services = [{
    ...
    description:
      "Car wash is a service that cleans the exterior and, in some cases, the interior of motor vehicles. Car washes can be self-service, fully automated, or full-service with attendants who wash the vehicle, sometimes with brushes or sponges, sometimes with high-pressure water jets. Some car washes also offer waxing, polishing, and other services.",
    brand: "Car Wash",
    category: "Services",
    price: 1000,
    countInStock: 7,
